...
function atualizarDecoracoesTema(tema) {
  const ensure = (id, cls, parentSelector, src) => {
  ...
  ensure("menuDecorTop", "theme-decor theme-decor-menu-top", ".menu-card", `./assets/images/menu-decor-top-${tema}.png`);
  ensure("menuDecorBottom", "theme-decor theme-decor-menu-bottom", ".menu-card", `./assets/images/menu-decor-bottom-${tema}.png`);
}
